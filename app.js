...
waShare.href = "https://wa.me/?text=" + encodeURIComponent("سلة مشترياتي: " + cartUrl);
snapShare.href = "https://www.snapchat.com/scan?attachmentUrl=" + encodeURIComponent(cartUrl);
twShare.href = "https://twitter.com/intent/tweet?text=" + encodeURIComponent("سلة مشترياتي: " + cartUrl);
fbShare.href = "https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(cartUrl);
});
	document.addEventListener('DOMContentLoaded', () => {
  // === العناصر ===
